...
const unifinder = graduates.map(graduate => graduate.university).sort();

console.log(unifinder);
...
const hasuni = graduates.filter(graduate => {
...
const animalName = zooAnimals.map(animal => animal.animal_name.toLowerCase()).sort();
